...
public class UnsharpMask: OperationGroup {
    @objc open var blurRadiusInPixels: Float { didSet { gaussianBlur.blurRadiusInPixels = blurRadiusInPixels } }
    @objc open var intensity: Float = 1.0 { didSet { unsharpMask.uniformSettings["intensity"] = intensity } }
